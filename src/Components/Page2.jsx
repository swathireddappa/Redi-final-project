...
function Page2() {
  ...
  return (
    <div className="img">
        <div className='image'>
        <img className='munp' src="https://ik.imagekit.io/8sp02fxgg/mun.jpg?updatedAt=1687177946704" alt="" />
        <Link to ='/Munpage' ><button className="munich">Munich</button></Link>
        </div>
        
        <div className='image'>
        <img className='munp' src="https://ik.imagekit.io/8sp02fxgg/itl.webp?updatedAt=1687174954380" alt="" />
        <Link to='/itlpage'> <button className="italy">Italy</button></Link>
        </div>

        <div className='image'>
        <img  className="munp" src="https://ik.imagekit.io/8sp02fxgg/barv.jpg?updatedAt=1687175583465" alt="" />
        <Link to='/Barcpage'><button className='barcelona'> Barcelona</button></Link>
        </div>

        <div className='image'>
        <img className='munp'  src="https://ik.imagekit.io/8sp02fxgg/prg.jpg?updatedAt=1687175771155" alt="" />
        <Link to='/Pragpage'><button className='prague'>Prague</button></Link>
        </div>

        <div className='image'>
        <img className='munp' src="https://ik.imagekit.io/8sp02fxgg/gdansk.jpg?updatedAt=1687177426964" alt="" />
